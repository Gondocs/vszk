...
const get = {
  ...
  SoftwareCompConnect: () => {
    ...
    return api.get('/SoftwareCompConnect/GetAll').then((response) => response.data);
  },

  SoftwareFunctions: () => {
      
    return api.get('/SoftwareFunctions/GetAll').then((response) => response.data);
  },

  SoftwareLangConnect: () => {
      
    return api.get('SoftwareLangConnect/GetAll').then((response) => response.data);
  },

  SoftwareModulConnect: () => {
      
    return api.get('SoftwareModulConnect/GetAll').then((response) => response.data);
  },

  SoftwareOSConnect: () => {
      
    return api.get('/SoftwareOSConnect/GetAll').then((response) => response.data);
  },
