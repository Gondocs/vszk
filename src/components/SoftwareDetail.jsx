  ...
  return (
    <div className="p-16">
      <div className="bg-gray-200 p-12 rounded-lg shadow-lg flex items-center">
        ...
        />
        <div className='p-4'>
          <h2 className="text-3xl font-semibold p-4">Név: {SoftwareData.name}</h2>
          <p className="text-lg font-semibold pt-4 pb-4 pl-4 pr-0">Értékelés: 4,6 ideiglenes{SoftwareData.rating}
          ...
          <button className='ml-4 mt-6 px-4 py-2 bg-yellow-400 hover:bg-yellow-500 rounded-md text-gray-900 font-semibold transition duration-300 inline-block' 
